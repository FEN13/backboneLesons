...
//Сохраняет текущеее состояния хранилища Store в localStorage.
...
//Добавляет в модель уникальный идентификатор GUID, если она еще не имеет его.
...
//Переопределяем Backbone.sync для использования с моделью или коллекцией в localStorage, которые должены быть экземпляром хранилища Store.
